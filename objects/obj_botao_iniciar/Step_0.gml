...
// Interrompe o audio do final do desafio caso ainda estiver tocando
if (variable_global_exists("id_audio_final") && audio_is_playing(global.id_audio_final)) {
    audio_stop_sound(global.id_audio_final);
}
